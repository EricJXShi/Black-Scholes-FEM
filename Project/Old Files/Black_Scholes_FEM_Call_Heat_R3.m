...
for j = 1:n_time
    ...
    for i = 1:n_blocks
        ...
        ket1 = alpha_coeff\(1/dtao - (1-theta)*beta)*dx(i, j); % Local 'Stiffness' Matrix for the current time step
        ket2 = alpha_coeff\(1/dtao + theta*beta)*dx(i, j); % Local 'Stiffness' Matrix for the next time step
